...
const books_info = [
  ...
  },
  {
    ...
    genre: "Dystopia",
    description:
      "Nineteen Eighty-Four (also known as 1984) is a dystopian novel by George Orwell, published in 1949. It explores the consequences of totalitarianism, mass surveillance, and manipulation of truth. The story is set in the year 1984 in a world at perpetual war. Great Britain, now Airstrip One, is controlled by the totalitarian superstate Oceania, led by the cult-like figure Big Brother. Government surveillance, historical manipulation, and propaganda stifle individuality and independent thought. The protagonist, Winston Smith, works for the Party but secretly rebels and falls in love with Julia. They discover a resistance group, the Brotherhood, but are betrayed and arrested. After months of torture, Winston comes to love Big Brother and the Party.",
...
link.addEventListener("click", (event) => {
  ...
  const userConfirmed = confirm(
    "Are you sure you want leave this page and visit random book?"
  );
...
function borrowBook() {
  if (localStorage.getItem("isLoggedIn")) {
    ...
    const isTitleMatch = borrowedBooks.some(
